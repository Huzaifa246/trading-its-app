...
const SignInviteLink = () => {
    const navigate = useNavigate()
    const { userName, userID } = useParams(); // Access route parameters
    ...
    const signupHandler = (e) => {
        ...
        axios.post(`${import.meta.env.VITE_APP_API}/api/users/invitation-signup/${userName}/${userID}`, credentials)
            .then((res) => {
